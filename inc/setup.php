...
add_action( 'wp_enqueue_scripts', 'custom_theme_enqueue_scripts', 4 );
...
add_action( 'after_setup_theme', 'custom_theme_register_nav_menu', 0 );
 ...
 * Allow SVG
 */
function custom_theme_add_file_types_to_uploads( $file_types ) {
    $new_filetypes = array();
    $new_filetypes['svg'] = 'image/svg+xml';
    $file_types = array_merge( $file_types, $new_filetypes );
    return $file_types;
}
add_filter('upload_mimes', 'custom_theme_add_file_types_to_uploads');

function custom_theme_add_block_group_inner( $block_content, $block ) {
...
add_filter( 'render_block_core/group', 'custom_theme_add_block_group_inner', 10, 2 );